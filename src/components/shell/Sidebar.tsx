...
export function Sidebar() {
	...
	return (
		<>
			...
			<aside
				className={`sidebar fixed lg:sticky left-0 top-0 z-50 flex h-screen flex-col border-r border-[var(--line)] bg-paper shadow-[var(--shadow-3)] transition-all duration-300 ${
